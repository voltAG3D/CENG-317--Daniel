...
public class Blue extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView connected = (TextView) findViewById(R.id.cond);
                ...
                while(!Thread.currentThread().isInterrupted())
                {
                    ...
                    try {
                        ...
                        if(bytesAvailable > 0)
                        {
                            ...
                            Log.e("robit recv bt","bytes available");
        ...
        if(pairedDevices.size() > 0)
        {
            ...
            {
                if(device.getName().equals("voltAG3D"))
                {
                    Log.e("Robit",device.getName());
                    mmDevice = device;
